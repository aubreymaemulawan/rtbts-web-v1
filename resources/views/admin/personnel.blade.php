            ...
            <div class="card-body pad">
                <div class="tbl table-responsive text-nowrap">
                    <table id=dataTable class="table table-hover">
                        ...
                        <tbody id="realtime_table_personnel" class="table-border-bottom-0">
        ...
        function loadXMLDoc() {
            ...
            xhttp.onreadystatechange = function() {
                if (this.readyState == 4 && this.status == 200) {
                    document.getElementById("realtime_table_personnel").innerHTML =
                    this.responseText;
                }
            };
            xhttp.open("GET", "./tbl-personnel", true);
            xhttp.send();
        }

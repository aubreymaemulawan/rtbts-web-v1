                        ...
                        <div class="box featured">
                            ...
                            <div class="table-responsive">
                                <table class="table table-hover dataTable" width="100%" cellspacing="1">
                                    ...
                                    <tbody id="realtime_landing_schedule">
                                    </tbody>
                                </table>
                            </div>
                        </div>
                        ...
                        <div class="box featured">
                            ...
                            <div class="table-responsive">
                                <table class="table table-hover dataTable" width="100%" cellspacing="1">
                                    ...
                                    <tbody id="realtime_landing_fare">
                                    </tbody>
                                </table>
                            </div>
                        </div>
        ...
        function loadXMLDoc_Schedule() {
            ...
            xhttp2.onreadystatechange = function() {
                if (this.readyState == 4 && this.status == 200) {
                    ...
                    document.getElementById("realtime_landing_schedule").innerHTML =
                    this.responseText;
                }
            };
            xhttp2.open("GET", "/tbl-landing-schedule", true);
            xhttp2.send();
        }

        function loadXMLDoc_Fare() {
            ...
            xhttp3.onreadystatechange = function() {
                if (this.readyState == 4 && this.status == 200) {
                    ...
                    document.getElementById("realtime_landing_fare").innerHTML =
                    this.responseText;
                }
            };
            xhttp3.open("GET", "/tbl-landing-fare", true);
            xhttp3.send();
        }

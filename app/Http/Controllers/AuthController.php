...
class AuthController extends Controller
{
    ...
    public function dashboard(Request $request){
        ...
        // Reminder Data
        $reminder = Reminder::with('company:id,company_name')
    ...
    public function schedule(Request $request){
        ...
        // Trip Data
        // $max_trips = PersonnelSchedule::where('id',$request->personnel_schedule_id)->value('max_trips');
            ...
            if($request->bus_status == 5){
                ...
                if($request->max_trips == $trip_cnt){
                    PersonnelSchedule::where('id', $request->personnel_schedule_id)->update(
                        array(
                            'status' => 2, // Personnel Schedule Inactive
                            'updated_at' => now(),
                        )
                    );
                }
